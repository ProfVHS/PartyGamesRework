...
export const createDatabaseTables = () => {
  db.serialize(() => {
    db.run(
      `CREATE TABLE rooms ( 'id' VARCHAR(5) PRIMARY KEY, 'round' INTEGER NOT NULL, 'players_ready' INTEGER NOT NULL, 'current_minigame' INTEGER NOT NULL, 'in_game' BOOLEAN NOT NULL, 'turn' INTEGER NOT NULL)`
    );
    db.run(
